SELECT * FROM dblink('dbname=lojadevarejo host=lojadevarejo user=equipefoda password=equipefoda',
'select * from tb002_cidades tc')
AS result(tb002_cod_cidade INTEGER, tb001_sigla_uf varchar(2), tb002_nome_cidade varchar(255));
...
select * from tb002_cidades tc;
select * from tb001_uf tu;
select * from tb003_enderecos te;
select * from tb004_lojas tl;
select * from tb006_cargos tc;
select * from tb005_funcionarios tf;
select * from tb005_006_funcionarios_cargos tfc;
select * from tb010_012_vendas tv;
select * from tb010_clientes c;
select * from tb010_clientes_antigos ct;
select * from tb011_logins tl;
select * from tb012_017_compras tc;
select * from tb012_produtos tp;
select * from tb013_categorias tc;
select * from tb014_prd_alimentos tpa;
select * from tb015_prd_eletros tpe;
select * from tb016_prd_vestuarios tpv;
select * from tb017_fornecedores tf;
select * from tb999_log tl;




DROP TABLE public.dim_lojas cascade;
DROP TABLE public.fat_vendas;

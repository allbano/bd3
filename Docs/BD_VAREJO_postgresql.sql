...
ALTER TABLE tb005_006_funcionarios_cargos
	ADD CONSTRAINT CONST_CAR;_FUNCCAR; FOREIGN KEY (tb006_cod_cargo) REFERENCES tb006_cargos(tb006_cod_cargo)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
...
INSERT INTO ADS.dbo.tb001_uf VALUES(';', 'Goiás')
...
INSERT INTO ADS.dbo.tb002_cidades VALUES(';', 'Goiânia')
